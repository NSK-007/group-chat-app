...
GroupRouter.put('/make-admin/:group_id/:user_id', (0, cors_1.default)({ origin: 'http://127.0.0.1:5501', methods: ["PUT"] }), authenticate_1.authenticate, group_controller_1.makeAdmin);
GroupRouter.delete('/remove-member/:group_id/:user_id', (0, cors_1.default)({ origin: 'http://127.0.0.1:5501', methods: ['DELETE'] }), authenticate_1.authenticate, group_controller_1.removeMember);
